...
COMMON_ERROR_RESPONSES = {
    ...
    403: {
        "model": APIErrorDetail,
        "description": "Current user does not have operation permission.",
    },
    404: {"model": APIErrorDetail, "description": "Specified resource does not exist."},
    409: {
        "model": APIErrorDetail,
        "description": "Resource state conflict, cannot complete operation.",
    },
    413: {
        "model": APIErrorDetail,
        "description": "Request content exceeds allowed size limit.",
    },
    ...
    *status_codes: int,
    ...
    for status_code in status_codes:
        ...
        if examples and status_code in examples:
            response["content"] = {
                "application/json": {"examples": examples[status_code]}
            }
