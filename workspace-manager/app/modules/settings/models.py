...
def default_tool_model(tool_id: AgenticToolId) -> str:
    return get_global_model_config(tool_id).default_model
...
class UserToolModelSelection(CamelModel):
...
class ClaudeCodeSettings(CamelModel):
    ...
    model_selection: UserToolModelSelection = Field(
        default_factory=UserToolModelSelection,
...
class CodexSettings(CamelModel):
    ...
    model: str = Field(default_factory=lambda: default_tool_model("codex"))
    model_selection: UserToolModelSelection = Field(
        default_factory=UserToolModelSelection,
        alias="modelSelection",
    )
...
class OpenCodeSettings(CamelModel):
    model: str = Field(default_factory=lambda: default_tool_model("opencode"))
    model_selection: UserToolModelSelection = Field(
        default_factory=UserToolModelSelection,
        alias="modelSelection",
    )
...
class UserSettingsUpdate(CamelModel):
    ...
    opencode: Optional[OpenCodeSettings] = None
