"""Marketplace importing workflow module."""
...
class MarketplaceImportWorkflow(_MarketplaceRegistrySupport):
    """Validate, stage, and atomically apply Marketplace importing."""
    ...
    def scan_import_source(
        ...
        """Validate an external importing source before target_client-native scanning."""
                ...
                try:
                    ...
                    failed.append(
                        self._failed_import_candidate(
                            ...
                            exc.code,
                            stage=exc.stage,
                            source=exc.source or request.source.source,
                    ...
                    _LOGGER.exception("Unexpected Marketplace importing failure")
                    failed.append(
                        self._failed_import_candidate(
                            candidate,
                            "marketplace.import.internal_failed",
                            stage="internal",
                            source=request.source.source,
                            destination=(
                                candidate.package_id
    ...
    def validate_import_source(
        ...
        """Validate importing source boundaries and return resolved source metadata."""
