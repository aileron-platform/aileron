...
DEFAULT_TEMPLATE_FEATURES = [
    ...
    {
        "id": "feature-slash-commands",
        "feature_key": "slashCommands",
    ...
    {
        "id": "feature-claude-md",
        "feature_key": "claudeMd",
        "feature_name": "Claude.md",
    ...
    {
        "id": "feature-sub-agents",
        "feature_key": "subAgents",
        "feature_name": "Sub Agents",
        "description": "Sub-agent definitions and configuration",
        "icon": "agent",
        "sort_order": 5,
        "cli_types": ["claude-code"],
    },
    {
        "id": "feature-output-styles",
        "feature_key": "outputStyles",
        "feature_name": "Output Styles",
...
def _create_docker_default_workspace(default_user: User) -> Workspace:
    return Workspace(
        ...
        web_preview_external_port=3003,
        web_preview_internal_url="http://workspace-nextjs-default-workspace:3003",
        web_preview_external_url="http://localhost:3003",
        ...
        nextjs_internal_url="http://workspace-nextjs-default-workspace:3003",
        nextjs_external_url="http://localhost:3003",
        nextjs_internal_port=3003,
        nextjs_external_port=3003,
