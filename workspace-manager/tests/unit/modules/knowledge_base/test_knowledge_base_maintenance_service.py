...
from app.modules.knowledge_base.maintenance import KnowledgeBaseMaintenanceService
...
def test_reconcile_kb_quota_updates_cached_sizes_and_detects_drift(
    ...
    with patch("app.modules.knowledge_base.maintenance.logger") as mock_logger:
...
def test_reconcile_kb_quota_includes_git_and_lfs_objects(
    ...
    (kb_dir / "notes.md").write_text("note", encoding="utf-8")
