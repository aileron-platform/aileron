...
|---------|------|---------|
| [Claude Code CLI](https://docs.claude.com/en/docs/claude-code/overview) | The most complete built-in agent CLI in the workspace today | Anthropic TOS |
| [`@anthropic-ai/claude-agent-sdk`](https://github.com/anthropics/claude-agent-sdk-typescript) | TS SDK used by the frontend to talk to Claude agents | MIT |
| [`claude-agent-sdk` (Python)](https://github.com/anthropics/claude-agent-sdk-python) | Python SDK used by workspace-runtime | MIT |
| [`agent-client-protocol`](https://pypi.org/project/agent-client-protocol/) | Bidirectional protocol between agent and frontend | MIT |
| [`agent-browser`](https://www.npmjs.com/package/agent-browser) | Rust-based agent CLI that drives workspace-browser over CDP | MIT |
| [Google Gemini CLI](https://github.com/google-gemini/gemini-cli) | One of the alternate runtimes in the platform's multi-agent architecture | Apache-2.0 |
| [OpenSpec CLI](https://www.npmjs.com/package/@fission-ai/openspec) | Built-in OpenSpec workflow CLI available inside each workspace | MIT |
| [Anthropic Python SDK](https://github.com/anthropics/anthropic-sdk-python) | Fallback path for calling the Anthropic API directly | MIT |
| [codex-universal](https://github.com/openai/codex-universal) | Base image used by workspace-runtime (multi-stage build) | MIT |
...
| [Chrome DevTools Protocol (CDP)](https://chromedevtools.github.io/devtools-protocol/) | Control channel: `agent-browser` ↔ `cdp-proxy` ↔ Chromium | — |
| [coturn](https://github.com/coturn/coturn) | TURN server for WebRTC NAT traversal in Kubernetes deployments | BSD-3-Clause |
...
| [Celery](https://docs.celeryq.dev/) + [Flower](https://github.com/mher/flower) + [Kombu](https://github.com/celery/kombu) | Task queue powering Scheduler / Automation | BSD-3-Clause |
...
| [python-keycloak](https://github.com/marcospereirampj/python-keycloak) | Keycloak OAuth2 / OIDC integration | MIT |
...
| [watchdog](https://github.com/gorakhargosh/watchdog) | Filesystem monitoring | Apache-2.0 |
| [pexpect](https://github.com/pexpect/pexpect) | Terminal interaction | ISC |
| [psutil](https://github.com/giampaolo/psutil) | System resource monitoring | BSD-3-Clause |
...
| [Keycloak](https://www.keycloak.org/) | Enterprise authentication (OAuth2 / OIDC / SSO) | Apache-2.0 |
...
| [Cilium](https://cilium.io/) | Network policy (workspace / browser allowlists) | Apache-2.0 |
