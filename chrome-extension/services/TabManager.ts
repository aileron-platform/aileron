...
export class TabManager {
  ...
  async attach(tabId: number): Promise<TargetInfo> {
    ...
    // Note: Using "default" for single-context scenario. For multi-context support,
    // this should ideally use "" (empty string) to match Chrome's default context behavior.
    ...
    this.sendMessage({
      ...
      params: {
        ...
        params: {
          sessionId,
          targetInfo: { ...targetInfo, attached: true, browserContextId: "default" },
