...
export interface BrowserExtensionPairingAssertion {
  assertion: string;
  runtimeInstanceId: string;
}

export interface BrowserExtensionPairingSession extends BrowserExtensionPairingAssertion {
  expiresAt: number;
}
...
export interface ConfigureBrowserExtensionPairingMessage {
...
export interface PairingConfigResponse {
  accepted: boolean;
  runtimeInstanceId?: string;
}
