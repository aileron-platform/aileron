...
import type { GlowEffectManager } from "../services/GlowEffectManager";
...
describe("CDPRouter", () => {
  ...
  let mockGlowEffect: GlowEffectManager;
  ...
  beforeEach(() => {
    ...
    } as unknown as GlowEffectManager;
