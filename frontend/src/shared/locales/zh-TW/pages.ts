    ...
    sections: {
      ...
      codex: {
        ...
        login: {
          title: 'ChatGPT 訂閱',
          account: '帳號',
          notConnectedDescription: '登入後可在 workspace container 中使用 ChatGPT 訂閱執行 Codex。',
      ...
      gemini: {
        title: 'Gemini 設定',
        description: '設定 Gemini CLI 的 Google 認證方式與環境變數。',
        authMethod: {
          label: '認證方式',
          description: '選擇 Gemini 認證方式',
          options: {
            subscription: 'Subscription',
            apikey: 'API Key',
          },
        ...
        subscription: {
          ...
          connectButton: '授權 Google 帳號',
          disconnectButton: '取消連結',
          authCodeLabel: '授權碼',
          authCodePlaceholder: '貼上 Google 授權頁面顯示的授權碼',
          authCodeHint: '在新視窗完成 Google 授權後，將授權碼貼到下方：',
          description: '您的 Google 帳號將供 workspace container 內的 Gemini CLI 使用。',
          status: {
            connected: '已連結',
            notConnected: '未連結',
          },
          ...
          oauthWindow: {
            openingTitle: '正在開啟認證視窗...',
            openingDescription: '請在彈出視窗中完成 Google 帳號授權。',
            openedTitle: '認證視窗已開啟',
            openedDescription: '請在新視窗中完成授權，完成後將授權碼貼到下方。',
            failedTitle: '無法開啟認證視窗',
            failedDescription: '請確認瀏覽器允許彈出視窗。',
            clientNotConfigured: 'Gemini Google OAuth 尚未完成設定。',
          },
          verifying: '正在驗證授權碼...',
          pleaseWait: '請稍候',
          saveButton: '儲存',
          ...
          success: {
            ...
            syncDescription: '認證成功！請點擊「同步設定」將設定同步到 Workspace。',
          },
          errors: {
            emptyCode: '請輸入授權碼',
            loginRequired: '請先登入後再進行 OAuth 認證',
            authFailed: '認證失敗',
            sessionExpiredTitle: '認證失敗',
            sessionExpiredDescription: '登入工作階段已過期，請重新登入後再試。',
            unknown: '無法完成認證',
          },
          disconnect: {
            loginRequiredTitle: '無法取消連結',
            successTitle: '已取消連結',
            successDescription: 'Google 認證資料已清除',
            failedTitle: '取消連結失敗',
            failedDescription: '請稍後再試',
          },
        },
        environmentVariables: {
          title: 'Gemini 環境變數',
          description: '這些變數會寫入 workspace runtime container。使用 GEMINI_API_KEY 設定 API Key 認證。',
        },
      },
      git: {
        title: 'Git 設定',
