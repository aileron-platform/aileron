const workspaceSettings = {
  ...
  knowledgeBases: {
    ...
    mounted: {
      title: '已生效的知識庫掛載',
      description: '顯示目前工作區已套用的知識庫掛載狀態。',
      pendingBadge: '待套用',
      signatureLabel: '掛載簽章',
      ...
      pendingDescription: '請重新啟動工作區，讓最新的知識庫掛載設定套用到執行環境。',
      pendingEmpty: '目前無法直接從 API 還原舊的已生效掛載清單；重啟工作區後會以最新設定重新掛載。',
      empty: '目前工作區沒有已掛載的知識庫。',
      restart: {
        label: '重啟工作區以套用',
        loading: '重啟工作區中...',
        successTitle: '工作區重啟已開始',
        successDescription: '知識庫掛載變更會在工作區重啟後生效。',
        errorTitle: '工作區重啟失敗',
        errorDescription: '無法重啟工作區套用知識庫變更。',
      },
    },
    form: {
