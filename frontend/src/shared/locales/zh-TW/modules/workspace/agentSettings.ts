    ...
    subagents: {
      ...
      dialog: {
        ...
        fields: {
          ...
          kind: { label: '類型', placeholder: 'local' },
          tools: { label: '工具', placeholder: 'Read, Grep, mcp_*' },
          model: { label: '模型', placeholder: '沿用預設值' },
          temperature: { label: 'Temperature', placeholder: '1' },
          maxTurns: { label: '最大回合數', placeholder: '30' },
          timeoutMins: { label: '逾時分鐘數', placeholder: '10' },
          content: {
            label: 'Subagent 描述',
            estimatedSize: '預估大小：{{size}}',
