  ...
  settings: {
    ...
    sections: {
      ...
      gemini: {
        ...
        description: 'Configure Google authentication method and environment variables for Gemini CLI.',
        authMethod: {
          label: 'Authentication Method',
          description: 'Choose Gemini authentication method',
          options: {
            subscription: 'Subscription',
            apikey: 'API Key',
          },
        ...
        subscription: {
          ...
          authCodeHint: 'Authorize Google in the new window, then paste the code below:',
          description: 'Your Google account will be used by the Gemini CLI in workspace containers.',
          status: {
            connected: 'Connected',
            notConnected: 'Not Connected',
          },
          ...
          oauthWindow: {
            openingTitle: 'Opening authentication window...',
            openingDescription: 'Complete Google authentication in the popup window.',
            openedTitle: 'Authentication window opened',
            openedDescription: 'Complete authentication in the new window, then paste the Authentication Code.',
            failedTitle: 'Unable to open authentication window',
            failedDescription: 'Please make sure your browser allows pop-up windows.',
            clientNotConfigured: 'Gemini Google OAuth is not configured yet.',
          },
          verifying: 'Verifying authentication code...',
          pleaseWait: 'Please wait',
          saveButton: 'Save',
        ...
        environmentVariables: {
          title: 'Gemini environment variables',
          description: 'These variables are written to workspace runtime containers. Use GEMINI_API_KEY for API key authentication.',
        },
      },
      git: {
        title: 'Git settings',
