    ...
    hooks: {
      ...
      dialog: {
        ...
        description: {
          ...
          gemini: 'Configure hook event, matcher, and execution commands.',
        },
        create: {
        ...
        executions: {
          ...
          timeoutHelp: {
            ...
            gemini: 'Maximum command execution time in milliseconds. Commands are cancelled when exceeding the limit.',
          },
          ...
          commandPlaceholder: {
            ...
            gemini: 'Enter the command to execute',
          },
          commandHelp: {
      ...
      events: {
        ...
        Setup: { label: 'Setup', description: 'Runs during Claude Code setup.', option: 'Setup' },
        UserPromptExpansion: { label: 'UserPromptExpansion', description: 'Runs when Claude expands a user prompt.', option: 'UserPromptExpansion' },
        PostToolUseFailure: { label: 'PostToolUseFailure', description: 'Runs after a tool call fails.', option: 'PostToolUseFailure' },
        PostToolBatch: { label: 'PostToolBatch', description: 'Runs after a tool batch completes.', option: 'PostToolBatch' },
        PermissionDenied: { label: 'PermissionDenied', description: 'Runs when permission is denied.', option: 'PermissionDenied' },
        StopFailure: { label: 'StopFailure', description: 'Runs when stop handling fails.', option: 'StopFailure' },
        SubagentStart: { label: 'SubagentStart', description: 'Runs when a subagent starts.', option: 'SubagentStart' },
        TeammateIdle: { label: 'TeammateIdle', description: 'Runs when a teammate becomes idle.', option: 'TeammateIdle' },
        TaskCreated: { label: 'TaskCreated', description: 'Runs when a task is created.', option: 'TaskCreated' },
        TaskCompleted: { label: 'TaskCompleted', description: 'Runs when a task completes.', option: 'TaskCompleted' },
        ConfigChange: { label: 'ConfigChange', description: 'Runs when configuration changes.', option: 'ConfigChange' },
        CwdChanged: { label: 'CwdChanged', description: 'Runs when the working directory changes.', option: 'CwdChanged' },
        FileChanged: { label: 'FileChanged', description: 'Runs when watched files change.', option: 'FileChanged' },
        InstructionsLoaded: { label: 'InstructionsLoaded', description: 'Runs when instructions are loaded.', option: 'InstructionsLoaded' },
        PostCompact: { label: 'PostCompact', description: 'Runs after context compaction.', option: 'PostCompact' },
        WorktreeCreate: { label: 'WorktreeCreate', description: 'Runs when a worktree is created.', option: 'WorktreeCreate' },
        WorktreeRemove: { label: 'WorktreeRemove', description: 'Runs when a worktree is removed.', option: 'WorktreeRemove' },
        Elicitation: { label: 'Elicitation', description: 'Runs during MCP elicitation.', option: 'Elicitation' },
        ElicitationResult: { label: 'ElicitationResult', description: 'Runs after MCP elicitation completes.', option: 'ElicitationResult' },
      },
      eventGroups: {
