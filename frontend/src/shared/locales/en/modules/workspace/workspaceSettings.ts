const workspaceSettings = {
  ...
  knowledgeBases: {
    ...
    mounted: {
      ...
      description: 'Shows the knowledge base mounts currently applied in the workspace.',
      ...
      pendingDescription: 'Restart the workspace to apply the latest knowledge base attachments.',
      pendingEmpty: 'The API cannot reconstruct the previous mounted list directly; restart the workspace to apply the latest configuration.',
      empty: 'The workspace currently has no mounted knowledge bases.',
      restart: {
        label: 'Restart workspace to apply',
        loading: 'Restarting workspace...',
        successTitle: 'Workspace restart started',
        successDescription: 'Knowledge base mount changes will apply after the workspace restarts.',
        errorTitle: 'Workspace restart failed',
        errorDescription: 'Failed to restart the workspace to apply knowledge base changes.',
      },
    },
    form: {
