    ...
    subagents: {
      ...
      dialog: {
        ...
        fields: {
          ...
          kind: { label: 'Kind', placeholder: 'local' },
          tools: { label: 'Tools', placeholder: 'Read, Grep, mcp_*' },
          model: { label: 'Model', placeholder: 'Inherited default' },
          temperature: { label: 'Temperature', placeholder: '1' },
          maxTurns: { label: 'Max turns', placeholder: '30' },
          timeoutMins: { label: 'Timeout minutes', placeholder: '10' },
          content: {
