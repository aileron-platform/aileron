const common = {
  ...
  hookEvents: {
    ...
    AfterModel: { label: 'AfterModel', description: 'Runs after Gemini receives a model response.' },
    BeforeToolSelection: { label: 'BeforeToolSelection', description: 'Runs before Gemini chooses the next tool.' },
