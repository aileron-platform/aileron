...
import { useOptionalI18n } from '@/shared/contexts/I18nContext';
...
>(({ className, children, ...props }, ref) => {
  ...
  const closeLabel = i18n?.t('common.close') ?? 'common.close';
  return (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid max-h-[calc(100vh-2rem)] w-[calc(100vw-2rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 sm:rounded-lg',
