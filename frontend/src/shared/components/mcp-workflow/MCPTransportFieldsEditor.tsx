...
export const parseMCPKeyValueText = (text: string, separator: string): Record<string, string> => {
...
export const toMCPKeyValueText = (record: Record<string, string>, separator: string): string =>
...
export default MCPTransportFieldsEditor;
