...
export const UsageStats: React.FC<UsageStatsProps> = ({ rawContent }) => {
  ...
  const statsLabel = t('workspace.preview.usage.stats');
  const totalTokensLabel = t('workspace.preview.usage.totalTokens');
  const inputLabel = t('workspace.preview.usage.input');
  const outputLabel = t('workspace.preview.usage.output');
  const costLabel = t('workspace.preview.usage.cost');
  const cacheLabel = t('workspace.preview.usage.cache');
  const tierLabel = t('workspace.preview.usage.tier');
  const cacheReadLabel = t('workspace.preview.usage.cacheRead');
  const cacheWriteLabel = t('workspace.preview.usage.cacheWrite');
  const costUnavailable = t('workspace.preview.usage.costUnavailable');
  const notAvailable = t('workspace.preview.usage.notAvailable');
  const durationLabel = t('workspace.preview.usage.duration');
  const providerLabel = t('workspace.preview.usage.provider');
  const modelLabel = t('workspace.preview.usage.model');
