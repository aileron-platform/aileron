        ...
        >
            ...
            {state.tabId && (
                <>
                    ...
                    {!hidePaneActions && typeof paneIndex === 'number' && (
                        <button
                            type="button"
                            className="flex w-full items-center gap-2 rounded px-2 py-1 text-left hover:bg-muted"
                            onClick={() => {
            ...
            {!hidePaneActions && isEmptyPane && tabs.length > 0 && (
                <>
                    <div className="my-1 h-px bg-border" />
                            ...
                            return (
                                ...
                                >
                                    <span className="truncate">
                                        {getTerminalTabTitle(tab.workingDirectory)}
                                    </span>
                                    {isUsed && (
