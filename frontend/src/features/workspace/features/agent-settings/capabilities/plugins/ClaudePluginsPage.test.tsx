...
const plugins = [
  {
    ...
    errors: [],
    resourceCounts: { commands: 1, agents: 0, hooks: 0, mcpServers: 0, skills: 1, outputStyles: 0 },
  },
  {
    id: 'build@community',
    name: 'Build Plugin',
    ...
    homepage: null,
    enabled: true,
    installations: [{ scope: 'project', enabled: true, version: '1.0.0', installedAt: null, lastUpdated: null }],
    errors: [],
    resourceCounts: { commands: 0, agents: 0, hooks: 0, mcpServers: 0, skills: 0, outputStyles: 0 },
  },
  {
    id: 'mixed@official',
    name: 'Mixed Plugin',
...
describe('ClaudePluginsPage', () => {
  ...
  it('renders marketplace and category filters and composes selected filters', async () => {
    ...
    render(<ClaudePluginsPage />, {
      initialRoute: '/workspaces/workspace-1/claude-code/plugins',
    });
