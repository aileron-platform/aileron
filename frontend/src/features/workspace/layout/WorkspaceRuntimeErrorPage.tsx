...
interface WorkspaceRuntimeErrorPageProps {
  error: string;
  isLoading?: boolean;
  onRetry?: () => void;
...
export const WorkspaceRuntimeErrorPage: React.FC<WorkspaceRuntimeErrorPageProps> = ({
  error,
  isLoading = false,
  onRetry,
  onCreateWorkspace,
  ...
  const noWorkspaceErrorKey = 'common.error.workspaceRuntime.noWorkspaceErrorMessage';
  const invalidWorkspaceErrorKey = 'common.error.workspaceRuntime.invalidWorkspaceErrorMessage';

  const isNoWorkspaceError =
    error.includes(noWorkspaceErrorKey) ||
    error.includes(invalidWorkspaceErrorKey) ||
    error.includes(t(noWorkspaceErrorKey)) ||
    error.includes(t(invalidWorkspaceErrorKey));
