...
export const FileChooserDialog: React.FC<FileChooserDialogProps> = ({ open, onOpenChange, onFileSelect, t }) => {
  ...
  useEffect(() => {
    ...
    if (!hasLoadedRef.current && fileTreeState.nodes.length === 0) {
      hasLoadedRef.current = true;
      void refreshFileTreeRef.current();
    }
  }, [open, fileTreeState.nodes.length]);
