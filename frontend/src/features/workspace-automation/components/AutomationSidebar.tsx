/**
 * AutomationSidebar - Automation center sidebar filters
 */

import React, { useMemo } from 'react';
import { CheckCircle2, Filter, PauseCircle, PlayCircle, SlidersHorizontal, type LucideIcon } from 'lucide-react';
...
const FILTER_ITEMS: Array<{ value: AutomationFilter; labelKey: string; icon: LucideIcon }> = [
  ...
  { value: 'completed', labelKey: 'automation.sidebar.filters.completed', icon: CheckCircle2 },
];
