...
import type { RuntimeConfigForm } from '../../model/workspaceWizardTypes';

interface RuntimeHelperActions {
  addEnvVar: () => void;
...
const RuntimeConfigStep: React.FC<RuntimeConfigStepProps> = ({
  data,
  onChange,
  helpers,
  onPrevious,
    ...
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          {t('workspace.wizard.steps.runtimeConfig.subtitle', { current: 2, total: 3 })}
        </p>
      </div>

      <div className="h-2 w-full rounded-full bg-muted">
        <div className="h-full rounded-full bg-primary transition-all" style={{ width: '66.6667%' }} />
      </div>
