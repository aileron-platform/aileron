...
- **Content pages** → information containers

Do not describe content pages as one fixed layout. Describe the content-page **visual grammar** instead:
...
- the content page may be more informational
...
- making the cover futuristic, the TOC editorial, and the content page dashboard-heavy unless that transition still clearly belongs to one shared system
...
After one style direction is confirmed, do one short style breakdown pass on the selected `首頁 / 目錄頁 / 內容頁` before writing planning files or generating final visuals.
