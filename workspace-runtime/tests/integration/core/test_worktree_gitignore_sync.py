...
from app.modules.version_control.worktree_gitignore import BEGIN_MARKER, END_MARKER
...
def test_sync_endpoint_rejects_unauthenticated_requests(client, tmp_path: Path, monkeypatch) -> None:
    client.headers.clear()
    monkeypatch.setattr(internal_router_module, "get_settings", lambda: SimpleNamespace(WORKSPACE_PATH=str(tmp_path)))
