...
class StubOutputStyleService:
    list_result: OutputStyleCollectionResponse | None = None
    scope_result: OutputStyleScopeResponse | None = None
    document_result: OutputStyleDocumentResponse | None = None
    create_result: OutputStyleDocumentResponse | None = None
    update_result: OutputStyleDocumentResponse | None = None
    delete_result: OutputStyleDeleteResponse | None = None
    ...
    def list_scopes(
        ...
        *,
        ...
        assert plugin_id == self.expected_plugin_id
...
def test_os_007_update_document(client):
    ...
    with override_dependency(get_output_style_service, lambda: service):
        response = client.put(
            f"/api/v1/workspaces/{WORKSPACE_ID}/claude-code/output-styles/project/markdown.json",
            json={"content": '{"layout": "columns"}', "revision": "document-revision"},
        )
