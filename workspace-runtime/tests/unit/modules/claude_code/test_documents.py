...
class TestWorkspaceRoot:
    ...
    @patch("app.modules.claude_code.documents.get_workspace_path")
...
class TestResolveScopeRoot:
    ...
    @patch("app.modules.claude_code.documents.workspace_root")
...
class TestScopedMarkdownRepository:
    ...
    @patch("app.modules.claude_code.documents.resolve_scope_root")
...
# Content"""
    ...
    @patch("app.modules.claude_code.documents.resolve_scope_root")
    def test_create_record_with_namespace(
        self, mock_resolve, repository, temp_workspace
    ):
    ...
    def test_create_record_duplicate(self, mock_resolve, repository, temp_workspace):
        ...
        with pytest.raises(DuplicateDocumentError):
            repository.create_record(
                workspace_id, DocumentScope.PROJECT, "existing", "# New"
            )
    ...
    @patch("app.modules.claude_code.documents.resolve_scope_root")
    def test_resolve_file_path_with_namespace(
        self, mock_resolve, repository, temp_workspace
    ):
    ...
    @patch("app.modules.claude_code.documents.resolve_scope_root")
    def test_resolve_file_path_without_namespace(
        self, mock_resolve, repository, temp_workspace
    ):
