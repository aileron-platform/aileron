...
def test_codex_path_resolver_uses_managed_home_and_workspace_paths() -> None:
    ...
    assert resolver.resolve(CodexLayer.USER, CodexResource.SKILLS) == Path("/home/developer/.codex/skills")
    assert resolver.resolve(CodexLayer.PROJECT, CodexResource.SKILLS) == Path("/workspace/.codex/skills")
