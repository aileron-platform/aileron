...
COMMON_ERROR_RESPONSES = {
    ...
    403: {"model": APIErrorDetail, "description": "Current user does not have permission."},
    404: {"model": APIErrorDetail, "description": "Specified resource does not exist."},
    409: {"model": APIErrorDetail, "description": "Resource state conflict, operation cannot be completed."},
