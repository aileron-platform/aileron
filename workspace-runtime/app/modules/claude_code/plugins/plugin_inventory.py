"""Internal Claude plugin inventory and execution-only CLI coordination."""
...
@dataclass(frozen=True)
class ClaudePluginInventorySnapshot:
...
def clear_claude_plugin_inventory_cache(cwd: Path | None = None) -> None:
...
def build_claude_plugin_inventory_snapshot(
    ...
    return ClaudePluginInventorySnapshot(
        rows=copied_rows,
